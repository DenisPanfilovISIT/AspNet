...
export class EditUlica extends Component {
    displayName = EditUlica.name
    ...
    constructor(props) {
        ...
        fetch('api/Ulica/GetUlica/?id=' + this.state.id, {
            method: "GET",
            headers: {
